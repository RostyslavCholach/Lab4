...
abstract public class Credit {
    ...
    protected void setBankName(String bankName) throws Exception {
        if(bankName.isEmpty()){
            throw new Exception("Empty line of bank name");
        }
    ...
    protected void setCreditPurpose(String creditPurpose) throws Exception{
        if(creditPurpose.isEmpty()){
            throw new Exception("Empty line of credit purpose");
        }
    ...
    protected void setMinimumCreditTerm(int minimumCreditTerm) throws Exception{
        if(minimumCreditTerm <= 0){
            throw new Exception("Incorrect value of minimum credit term");
        }
    ...
    protected void setMaximumCreditTerm(int maximumCreditTerm) throws Exception {
        if(maximumCreditTerm <= 0){
            throw new Exception("Incorrect value of maximum credit term");
        }
    ...
    protected void setMinimumCreditAmount(double minimumCreditAmount) throws Exception{
        if(minimumCreditAmount < 0){
            throw new Exception("Incorrect value of minimum credit amount");
        }
    ...
    protected void setMaximumCreditAmount(double maximumCreditAmount) throws Exception{
        if(maximumCreditAmount > 1000000){
            throw new Exception("Incorrect value of maximum credit amount");
        }
    ...
    protected void setMinimumInterestRate(double minimumInterestRate) throws Exception
    {
        if(minimumInterestRate < 0.0 || minimumInterestRate > 100.0){
            throw new Exception("Incorrect value of minimum interest rate");
        }
    ...
    protected void setMaximumInterestRate(double maximumInterestRate) throws Exception {
        if(maximumInterestRate < 0.0 || maximumInterestRate > 100.0){
            throw new Exception("Incorrect value of maximum interest rate");
        }
