...
public class Client {
    ...
    public void setFirstName(String firstName) throws Exception {
        if(firstName.isEmpty()){
            throw new Exception("Empty line of first name");
        }
        this.firstName = firstName;
    }
    ...
    public void setSecondName(String secondName) throws Exception {
        if(secondName.isEmpty()){
            throw new Exception("Empty line of second name");
        }
        this.secondName = secondName;
    }
    ...
    public void setAge(int age) throws Exception{
        if(age < 0 || age > 100){
            throw new Exception("Incorrect value of age");
        }
        this.age = age;
    }
    ...
    public void setCitizenship(String citizenship) throws Exception {
        if(citizenship.isEmpty()){
            throw new Exception("Empty line of citizenship");
        }
        this.citizenship = citizenship;
    }
    ...
    public void setWorkPlace(String workPlace) throws Exception {
        if(workPlace.isEmpty()){
            throw new Exception("Empty line of work place");
        }
        this.workPlace = workPlace;
    }
    ...
    public void setFinancialPosition(double financialPosition) throws Exception{
        if(financialPosition < 0.0){
            throw new Exception("Incorrect value of financial position");
        }
        this.financialPosition = financialPosition;
    }
    ...
    public void setRealEstateValue(double realEstateValue) throws Exception {
        if(realEstateValue < 0.0){
            throw new Exception("Incorrect value of real estate value");
        }
        this.realEstateValue = realEstateValue;
    }
    ...
    public void setCreditHistory(int creditHistory) throws Exception {
        if(creditHistory < 0 || creditHistory > 3){
            throw new Exception("Incorrect value of credit history");
        }
        this.creditHistory = creditHistory;
    }
